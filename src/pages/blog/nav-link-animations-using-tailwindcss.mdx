...
Browsing through CSS tricks and Stackoverflow I found some posts that showed how the pseudo-element _after_ can be used to create an element behind the actual nav link whose background then can be used to simulate a border for the parent element like so:
 */}
